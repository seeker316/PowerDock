...
#define BUFFER_SIZE 128  // Define buffer size
...
#define MSP_ANALOG               110    //out message         13, powermetersum, rssi if available on RX
...
///////////////////////////////////////////////////////////////////////////////
//void handleUART(float *s1, float *s2, float *s3) {
//    UART.init(UART2, BAUD_RATE_9600);
//    if (UART.rxBytesWaiting(UART2)) {
//        char receivedChar = (char)UART.read8(UART2);
//        static bool messageStarted = false;
//        static int bufferIndex = 0;
//        static char inputBuffer[BUFFER_SIZE];
//
//        if (!messageStarted && (receivedChar == 'U' )) {
//            messageStarted = true;
//            bufferIndex = 0;
...
//                if (inputBuffer[0] == 'U' && inputBuffer[1] == ':') {
//                    // Parse the message U:{value1,value2,value3}
...
//                    inputBuffer[bufferIndex++] = receivedChar;
//                } else {
//                    messageStarted = false; // Discard the message
//                    bufferIndex = 0;
//                }
//            }
//        }
...
//    if (message[0] == 'U' && message[1] == ':') {
//        float s1, s2, s3;
//        if (sscanf(message, "U:{%f,%f,%f}", &s1, &s2, &s3) == 3) {
//            headSerialReply(12);
//            serialize32((uint32_t) 70001);
//            serialize32((uint32_t)s2);
//            serialize32((uint32_t)s3);
//        }
//    }
//}
//
        				...
        				if (receivedChar == '\n') {
        					...
        					if (inputBuffer[0] == 'A' && inputBuffer[1] == ':') {
        						...
        						if (sscanf(inputBuffer, "U:{%f,%f,%f}", &s1, &s2, &s3) == 3) {
										...
										serialize32((uint32_t) (s1*536870912));
										serialize32((uint32_t) (s2*536870912));
										serialize32((uint32_t) (s3*536870912));
...
//            headSerialReply(12);
//            serialize32((uint32_t) 70055);
//            serialize32((uint32_t) 70069);
